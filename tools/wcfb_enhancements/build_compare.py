...
:root {
  --bg: #f6f1e6;
  --ink: #1a1a1a;
  /* Phase 9 a11y: WCAG AA 4.5:1 — was #7a7a7a (4.06:1 borderline on cream) */
  --muted: #5e5e5e;
  --card: #ffffff;
  --stroke: rgba(26,26,26,0.14);
  --accent: #c9a24a;
}
/* Phase 9 a11y: skip-link */
.wcfb-skip-link {
  position: absolute;
  left: -9999px;
  top: auto;
...
<body>
<a href="#main-content" class="wcfb-skip-link">Skip to main content</a>
<div class="page">
  ...
  <main id="main-content" class="wcfb-compare">
