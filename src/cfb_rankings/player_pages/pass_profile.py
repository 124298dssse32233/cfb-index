...
def render_pass_profile(
    ...
    return (
        ...
        '<div>'
        '<p class="pass-profile__eyebrow">Pass Profile · Completion depth (PBP)</p>'
        '<p class="pass-profile__title">Where the throws are landing</p>'
        '</div>'
        f'<span class="pass-profile__meta">{total_comp}/{total_att} ({cmp_pct:.1f}%) · '
        f'{total_tds} TD · {total_ints} INT</span>'
        '</header>'
