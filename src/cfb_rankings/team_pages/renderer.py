...
from .era_chapter_module import render_era_chapters, ERA_CHAPTER_CSS
from .atlas_chip_module import render_atlas_chip, ATLAS_CHIP_CSS
...
def _render_page(
    *,
    ...
    era_chapter_html = render_era_chapters(db, profile, snapshot) if db is not None else ""
    atlas_chip_html = render_atlas_chip(db, profile, snapshot) if db is not None else ""
    ...
    act_identity = _act(
        ...
        cultural_anchors_html, fanbase_health_html, voice_profile_html, lexicon_html, era_chapter_html, atlas_chip_html,
        home_field_html,
...
/* Fan-voice era chapter bands (Language Layer Wave 4) */
{ERA_CHAPTER_CSS}

/* Discourse Atlas fanbase cluster chip (Language Layer Wave 4) */
{ATLAS_CHIP_CSS}
