...
def _archive_w18() -> tuple[Edition, list[EditionFeature], list[EditionVoice]]:
    ...
    features = [
        EditionFeature(
            ...
            dek=(
                "Cover essay scaffold — auto-filled by the Pattern C generator "
                "on the next world_class_enrich run. Edition is in 'draft' "
                "status until the cover essay materializes."
            ),
            body_markdown=(
                "[Auto-generated content placeholder]\n\n"
                "This edition's cover essay will be generated by the Pattern C "
                "critique loop (Opus 4.7 + voice/headline/factuality critics + "
                "1 revise pass) on the next world_class_enrich run. Until then, "
                "this draft entry exists so the archive page can show six "
                "issues (XIV-XIX) and so the cover_essay surface has a row "
                "to UPDATE rather than INSERT against."
            ),
            byline="By The Editor's Desk", read_time_minutes=4,
        ),
        EditionFeature(
        ...
        EditionFeature(
            ...
            body_markdown=(
                "[Auto-generated content placeholder — Receipts Desk variant]\n\n"
                "The Pattern C generator will pull this week's resolved-claims "
                "from predictive_claims with surprise_index >= 30 and aged_well_pct "
                "calculated on the pre-draft → post-draft window."
            ),
            byline="By The Receipts Desk", read_time_minutes=3,
        ),
    ]
...
def _archive_w19() -> tuple[Edition, list[EditionFeature], list[EditionVoice]]:
    ...
    features = [
        EditionFeature(
            ...
            dek=(
                "Cover essay scaffold — auto-filled by the Pattern C generator "
                "on the next world_class_enrich run."
            ),
            body_markdown=(
                "[Auto-generated content placeholder]\n\n"
                "Pattern C cover essay generator will produce a ~1,200 word "
                "essay on the May 11 cohort-mood dumbbell, in-flight storylines, "
                "and resolved receipts from the prior 4-week window. Pulls from "
                "build_edition_cover_context per IMPLEMENTATION_PLAN.md Part 4."
            ),
            byline="By The Editor's Desk", read_time_minutes=4,
        ),
        EditionFeature(
        ...
        EditionFeature(
            ...
            dek="The five storyline arcs the Pattern E continuity loop is currently advancing.",
            body_markdown=(
                "[Auto-generated content placeholder — Connections Desk variant]\n\n"
                "Pattern C will pull the active storyline_threads (status=active) "
                "and surface the three with the most recent chapter activity. "
                "Pattern E continuity loop's named-entity ledger guarantees the "
                "writeups respect prior chapter framing."
            ),
            byline="By The Connections Desk", read_time_minutes=3,
        ),
    ]
