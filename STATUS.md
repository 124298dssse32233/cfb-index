...
- **In flight:** None
- **Blocked:** Remaining cross-surface instrumentation (Heisman model, Reality Gap) + the rendered methodology calibration page + per-team track-record sections are Phase 2-3 (in-season) — the resolver needs in-season outcome tables and the running gate is "≥10k rows in first in-season month."
